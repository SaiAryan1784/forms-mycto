...
export default function Home() {
  return (
    <div>
      ...
      <Link href="/form2" className="text-black bg-slate-200 hover:bg-slate-600 hover:text-slate-200 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center m-[2rem]">
        Fill up Form - 2
      </Link>
    </div>
  )
